    ...
    return product && (
       ...
       ( <AnimatePresence>
        ...
        onClick={() => {navigate(`/products/${product.category.toLowerCase()}/${product._id}`); scrollTo(0,0)}}
          className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 flex justify-between
           flex-col bg-white   w-full shadow-lg shadow-gray-700 dark:bg-[#0F0F0F] dark:border-[#303030]">
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div onClick={(e) =>{e.stopPropagation(); }} className="flex items-end justify-between mt-3">
                    <p className="md:text-xl text-base font-medium text-[#274472]">
                    ...
                    <div className="text-[#274472]">
                        {!cartItems[product._id] ? (
                            ...
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-[#274472]/25 rounded select-none">
