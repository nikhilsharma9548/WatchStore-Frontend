                ...
                <div onClick={(e) =>{e.stopPropagation(); }} className="flex items-end justify-between mt-3">
                    ...
                    <div className="text-[#274472] dark:text-gray-200">
                        {!cartItems[product._id] ? (
                            ...
                            <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] dark:text-gray-300/30  dark:border-gray-400 border border-[#274472]/60 md:w-[80px] w-[64px] h-[34px] rounded text-[#274472] font-medium cursor-pointer" onClick={() => addToCart(product._id)} >
                                <p><IoCartOutline/></p> bg-[#274472]/25 dark:text-gray-300/25 rounded select-none">
