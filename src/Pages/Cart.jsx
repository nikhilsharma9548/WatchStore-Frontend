                                    ...
                                    <div className='flex items-center '>
                                        ...
                                        className='outline-none '>
                                            {Array(cartItems[product._id] > 9 ? cartItems[product._id] : 9 ).fill('').map((_, index) => (
                                                <option key={index} value={index + 1} className="dark:bg-[#181818] ">{index + 1}</option>
                                            ))}
                                        </select>
                                    </div>
                                </div>
            ...
            <div className={` max-w-[360px] w-full shadow-xl p-5 max-md:mt-16 border dark:bg-[#0F0F0F] dark:border-[#303030]  dark:text-white bg-gray-100 border-gray-300/70 `}>
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() => setShowAddress(!showAddress)} className="text-[#274472] rounded-md  dark:text-gray-300 hover:underline cursor-pointer">
                            Change
                        </button>
                        {showAddress && (
                    ...
                    <select onChange={e => setPaymentOption(e.target.value)} className="w-full border dark:text-black border-gray-300 bg-white px-3 py-2 mt-2 outline-none">
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer
                 bg-[#274472] text-white font-medium dark:bg-red-700
                 dark:hover:bg-red-800 hover:bg-[#274472]/80 transition">
