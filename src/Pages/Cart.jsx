            ...
            <div className={` max-w-[360px] w-full shadow-xl p-5 max-md:mt-16 border dark:bg-[#0F0F0F] dark:text-white bg-gray-100 border-gray-300/70 dark:border-[#303030]`}>
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500 dark:text-black">{selectedAddress ? `${selectedAddress.street}, ${selectedAddress.city}, ${selectedAddress.state}, ${selectedAddress.country}` : "No address found"}</p>
